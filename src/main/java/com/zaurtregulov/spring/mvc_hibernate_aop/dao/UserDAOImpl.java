...
/* Специализированный @Component для DAO. Это Component для DAO, при поиске компонентов,
Spring будет регистрировать все DAO с аннотацией Repository в Spring Container */
@Repository()
